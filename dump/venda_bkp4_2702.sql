...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/02/2025 às 16:01
...
(2, 'Tablet', 'Tablet com a versão 16 do sistema operacional Android, tela 10 polegadas e armazenamento de 128GB', 900.00, 10, 5),
(3, 'Geladeira', 'Refrigerador frodt-free com aceeso á internet', 5000.00, 12, 6),
(5, 'iPad Mini', 'Tablet Apple com tela retina display e bla bla bla', 4999.12, 5, 3),
...
(8, 'Teclado Gamer', 'Tecladinho top', 300.00, 3, 2),
(9, 'Garrafa Termica', 'Deixa geladinho', 156.45, 25, 8),
(10, 'Smartphone Poco X7', 'Celular ching ling', 1999.99, 7, 3),
(11, 'Smart TV', 'TV curvada com tela 50 polegadas e acesso a Netflix', 1587.12, 15, 5);
